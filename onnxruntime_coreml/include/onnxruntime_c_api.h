 ...
 *
 * Refer to https://www.onnxruntime_gpu.ai/docs/performance/graph-optimizations.html#graph-optimization-levels
 ...
 */
// Whenever this struct is updated, please also update the MakeKey function in onnxruntime_gpu / core / framework / execution_provider.cc
...
typedef struct OrtTensorRTProviderOptions {
  ...
  // For new field that can be represented by string, please add it in include/onnxruntime_gpu/core/providers/tensorrt/tensorrt_provider_options.h
 ...
 * Argument is an onnxruntime_gpu built-in type which will be provided when thread pool calls OrtCustomCreateThreadFn
 */
 ...
 *
 * The function should return a thread handle to be used in onnxruntime_gpu thread pools
...
struct OrtApi {
   ...
   *
   * Please see https://onnxruntime_gpu.ai/docs/performance/model-optimizations/graph-optimizations.html for an in-depth explanation
   ...
   *
   * See https://onnxruntime_gpu.ai/docs/get-started/with-c.html for details.
   *
   ...
   *
   * Supported keys are (See https://onnxruntime_gpu.ai/docs/get-started/with-c.html for details on what the
   ...
   *
   * Please refer to https://onnxruntime_gpu.ai/docs/execution-providers/TensorRT-ExecutionProvider.html#cc
   ...
   *
   * See onnxruntime_gpu-extensions: https://github.com/microsoft/onnxruntime_gpu-extensions.git
   *
   * \snippet{doc} snippets.dox OrtStatus Return Value
   */
   ...
   *
   * Please refer to https://onnxruntime_gpu.ai/docs/execution-providers/CUDA-ExecutionProvider.html#configuration-options
  ...
  /** \brief: Create attribute of onnxruntime_gpu operator
   *
  ...
  /** \brief: Create onnxruntime_gpu native operator
   *
  ...
  /* \brief: Release an onnxruntime_gpu operator
   *
   ...
   *
   * See https://onnxruntime_gpu.ai/docs/reference/operators/add-custom-op.html for details on how the registration
   ...
   *
   * Please refer to https://onnxruntime_gpu.ai/docs/execution-providers/ROCm-ExecutionProvider.html
