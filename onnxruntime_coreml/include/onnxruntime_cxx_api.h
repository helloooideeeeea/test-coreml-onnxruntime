...
// Used by custom operator libraries that are not linked to onnxruntime_gpu. Sets the global API object, which is
// required by C++ APIs.
//
...
/// <summary>
/// This function returns the onnxruntime_gpu version string
/// </summary>
/// <returns>version string major.minor.rev</returns>
std::string GetVersionString();

/// <summary>
/// This function returns the onnxruntime_gpu build information: including git branch,
...
/// See usage example in onnxruntime_gpu/test/testdata/custom_op_library/custom_op_library.cc
/// </summary>
